    ...
    public partial class frm_listaOrdemServico : Form
    {
        ...
        */
        ...
        private void frm_listaOrdemServico_Load(object sender, EventArgs e)
        {
            ...
            this.lvw_listaOrdemServico.Columns.Add("Cliente-Base", 300).TextAlign = HorizontalAlignment.Left;
            this.lvw_listaOrdemServico.Columns.Add("Título", 500).TextAlign = HorizontalAlignment.Left;
            this.lvw_listaOrdemServico.Columns.Add("Valor", 100).TextAlign = HorizontalAlignment.Right;
            this.lvw_listaOrdemServico.Columns.Add("Nota Fiscal", 100).TextAlign = HorizontalAlignment.Left;
